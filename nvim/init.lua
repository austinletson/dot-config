...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Setup each LSP server manually using the new vim.lsp.config API
      for server_name, server_config in pairs(servers) do
        ...
        -- Enable the LSP server for appropriate filetypes
  ...
  require 'kickstart.plugins.neotest_python',
